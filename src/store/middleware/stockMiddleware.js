...
export default class StockMiddleware {
    ...
    static addProductOnDatabase(dispatch,productObj,token){
        ...
        //     });
        instance.post("/AddProduts",{name:productObj.name,manufacture:productObj.manufacture,description:productObj.description,amount:productObj.amount,quantity:productObj.quantity,date:productObj.date},instance.defaults.headers.token = token)
